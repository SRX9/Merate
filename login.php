...
if (isset($_POST['login'])) {
    ...
    try {
        ...
        $query = $dbhandler->query("select id from user_details where username='$username' and Password='$pass'");
        ...
        if (count($result) == 0)
            ...
            header("Location: http://localhost/med/index.php");
        }
...
<body>
    ...
    <section class="case-study">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="heading purple" style="padding-left:20px;"><span class="purple">Login</span><br>
                    </h1>
